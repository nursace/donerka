...
import {View, Image,Text,Easing, ActivityIndicator,Platform,Animated,TouchableWithoutFeedback, AsyncStorage} from 'react-native'
    ...
    return (
      <Router>
        <Scene key="root" hideNavBar>
          ...
          <Scene kye='editProfile' component={EditProfile} />
